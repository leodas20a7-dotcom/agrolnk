    ...
    return [
      {
        ...
        title: 'Welcome to Agrolnk Exchange',
        message: 'Your farm profile is verified. You can now list harvest lots and receive direct buyer payments.',
        type: 'system',
      ...
      },
      {
        ...
        message: 'Zero cash risk at farmgate. 100% of purchase values are pre-funded before dispatch.',
        type: 'escrow',
        link: '/farmer-orders',
        isRead: false,
    ...
    return [
      {
        ...
        message: 'Verified farm-direct commodities available for procurement at wholesale spot rates.',
        type: 'order',
      ...
      },
      {
        ...
        message: 'Apply for 15–45 day post-harvest trade credit from institutional NBFC partners.',
        type: 'financing',
    ...
    return [
      {
        ...
        title: 'Freight Corridors Ready',
        message: 'Farmgate produce loads available for carrier bidding with guaranteed trip settlements.',
        type: 'delivery',
    ...
    return [
      {
        ...
        title: 'Underwriting Desk Active',
        message: 'Trade credit applications with automated digital collateral and buyer ratings.',
        type: 'financing',
